const APIController = (function () {
    ...
    const _createPlaylist = async () => {
        ...
        const emptyPlaylist = await fetch(`https://api.spotify.com/v1/users/21doakiooz7smngjx7nkifqui/playlists`, {
            ...
            headers: {
                ...
                'Authorization': 'Bearer ' + 'BQC1tjjLas0GRqKWzUhEubd-ixPRaHfQ6G5wvZJIGmdgugBwcFyp0ol922WtOyKUXIF5ofT451aLH6XN-Iu9BOTo3RsZtAUkq7qmsO71cCUbEI-_BHW5sx-zvmjwr0I-739aE_zZ6xzjJTD6YNjxBhAlScxrAocR6Bnzn61ucyv0TVjp50kkguwru7jSxAr7w9PRu6rwb88kP3WiPGOEnh9trzOMLVD3d_mDA4Iznmt6ve6R3tDVmHD8'
            }
        })
    ...
    const _addSongs = async (id, uris) => {
        ...
        const result = await fetch(`https://api.spotify.com/v1/playlists/${id}/tracks`, {
            ...
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + 'BQARsSjUdwomuTm78p-J_mA7OG-6loMvusHxIV3s3jdx0GO-TDSp6uwJIVPfD1XpLi0EBNWm_VqYVOY_pyO_Q8TGxqtple3hsF4JNZm_mjknnO8UcilIOBQMjzmOPruBvVaaZp63lnpsU7GlSskqx55kHaA2WR_RL54VHeuBUOmMv_A-x3nU7DzLT2kPnByhgSXTUwXzikPO8PPe4610TvcmUVTWF0rf4LRXGmIEXbpdHVQiqSC2VTiN'
            },
            body: JSON.stringify({
                'uris': uris
            })
